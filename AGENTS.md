...
The visual system follows `docs/design-brief.md` (derived from a reverse-engineered
design system; keep the grammar, not any borrowed assets). Read it before UI work.
